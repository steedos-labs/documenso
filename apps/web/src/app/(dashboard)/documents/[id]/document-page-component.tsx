...
export default async function DocumentPageComponent({ params, team }: DocumentPageComponentProps) {
  ...
  const documentRedirect = team ? `/t/${team.url}/documents` : '/documents';

  if (!documentId || Number.isNaN(documentId)) {
    redirect(documentRedirect);
  }
  ...
  return (
    <div className="mx-auto -mt-4 w-full max-w-screen-xl px-4 md:px-8">
      <Link href={documentRedirect} className="flex items-center text-[#7AC455] hover:opacity-80">
